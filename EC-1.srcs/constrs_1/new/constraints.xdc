...
##Switches
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports {Input[0]}]
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports {Input[1]}]
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {Input[2]}]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {Input[3]}];
...
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports Halt]
...
set_property PACKAGE_PIN N16 [get_ports {Output[7]}]
set_property PACKAGE_PIN L14 [get_ports {Output[6]}]
set_property PACKAGE_PIN L15 [get_ports {Output[5]}]
set_property PACKAGE_PIN J15 [get_ports {Output[4]}]
...
set_property PACKAGE_PIN K18 [get_ports {Input[4]}]
set_property PACKAGE_PIN P16 [get_ports {Input[5]}]
set_property PACKAGE_PIN K19 [get_ports {Input[6]}]
set_property PACKAGE_PIN T19 [get_ports {Input[7]}]
...
set_property PACKAGE_PIN K16 [get_ports {Output[3]}]